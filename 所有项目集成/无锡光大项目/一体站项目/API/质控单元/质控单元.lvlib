...
<Library LVVersion="16008000">
	...
	<Item Name="平行样启动流程对话框.vi" Type="VI" URL="../../CODMn/平行样启动流程对话框.vi"/>
	<Item Name="氨氮总磷平行样流程.vi" Type="VI" URL="../氨氮总磷平行样流程.vi"/>
	<Item Name="COD平行样流程 (子VI).vi" Type="VI" URL="../COD平行样流程 (子VI).vi"/>
	<Item Name="平行样启动参数选择对话框.vi" Type="VI" URL="../../CODMn/平行样启动参数选择对话框.vi"/>
	...
	<Item Name="质控启动流程对话框.vi" Type="VI" URL="../../CODMn/质控启动流程对话框.vi"/>
	<Item Name="氨氮加标回收状态全局变量.vi" Type="VI" URL="../氨氮加标回收状态全局变量.vi"/>
	<Item Name="质控启动参数选择对话框.vi" Type="VI" URL="../../CODMn/质控启动参数选择对话框.vi"/>
	<Item Name="氨氮加标回收.vi" Type="VI" URL="../氨氮加标回收.vi"/>
